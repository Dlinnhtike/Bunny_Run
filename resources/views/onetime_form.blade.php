...
<div class="container-fluid body_frame">
   ...
   <div class="row">
           <div class="col-lg-8 offset-lg-2">
            <h1 class="content_heading_text" style="margin-top:50px;">Deli Order Request Form <br><small style="font-size:14px; color:#a6a6a6;">By One Time User</small></h1>
            ...
            <div class="tab-pane fade show active" id="step1">
              ...
              <div class="row g-3">
                    <div class="col-lg-6 col-md-6">
                        ...
                        <input type="text" class="form-control margin_bottom_10" id="" name="name" value="" required>
                        <input type="hidden" name="user_id" value="">
                        <label for="" class="form-label">Phone</label>
                        <input type="text" class="form-control margin_bottom_10" id="" name="phone" value="" required>
                    
                        <label for="" class="form-label">Address</label>
                        <input type="text" class="form-control margin_bottom_10" id="" name="address" value="" required>
