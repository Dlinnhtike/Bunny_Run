...
<div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <a href="{{url()->previous();}}"><i class="fa fa-arrow-circle-left" data-toggle="tooltip"title="Back"></i></a>
        Office
        <small class="text-black">Create Employee</small>
      </h1>
      <ol class="breadcrumb">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="box box-warning">
                <div class="box-body">
                    <div class="row">
                    <form role="form" action="{{url('add_employee')}}" method="POST">
                            @csrf
                    <div class="col-lg-6">  
                    <!-- {{ Request::segment(1) }} -->
                        ...
                        <div class="box-body">
                            ...
                            <input type="text" class="form-control" id="" name="emp_name" placeholder="Name" value="{{old('emp_name')}}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="" name="phone" placeholder="Phone Number" required>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="" name="join_date" value="{{old('join_date')}}" required>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="remark" class="form-control" placeholder="Type Remark for your Employee"></textarea>
                            </div>
                            <divclass="form-group">
