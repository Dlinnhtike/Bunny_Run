   ...
   <div class="container ">
        <div class="row">
           <div class="col-lg-8 offset-lg-2 success_login_frame">
                ...
                @endif
                    <div class="col-lg-5 login_left_bg">
                        <img src="{{asset('img/login_bg.jpg')}}" alt="">
                    </div>
                    <div class="col-lg-7 login_right_form">
                    <form action="{{url('login')}}" class="log-in" autocomplete="off" method="POST"> 
                        @csrf
                    <h4 style="color:#5e5f61; border:1px solid red;">Welcome <span style="color:#000;">{{session('user_name')}}</span></h4>
                    <p>Thank you for choosing Bunny Run. Your Registration is finished</p>
                    <div class="floating-label">
                        <input placeholder="User Name" type="text" name="username" id="" autocomplete="off" style="outline: 0;" value="{{session('user_name')}}">
